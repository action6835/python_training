...
class ContactHelper:
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return Contact(firstname=firstname, lastname=lastname, address=address, home=homephone, mobile=mobilephone,
                       work=workphone, email=email, email2=email2, email3=email3, phone2=secondaryphone, id=id)
