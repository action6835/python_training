...
class AddNew(unittest.TestCase):
    ...
    def test_add_new(self):
        ...
        self.create_contact(wd, firstname="first name", middlename="inital", lastname="last name", nickname="nickname", title="title", company="company", address="address", home="111",
