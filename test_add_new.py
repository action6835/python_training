...
class AddNew(unittest.TestCase):
    ...
    def test_add_new(self):
        ...
        wd.find_element_by_name("middlename").send_keys("inital")
        ...
        wd.find_element_by_name("email").send_keys("111@m.ru")
        wd.find_element_by_name("email2").click()
        wd.find_element_by_name("email2").clear()
        wd.find_element_by_name("email2").send_keys("222@m.ru")
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys("333@m.ru")
